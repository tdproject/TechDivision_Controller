...
/**
 * Objects of this class contains errors that occurs
 * for example during the validation of an ActionForm.
 *
 ...
 */
class TechDivision_Controller_Action_Error 
    ...
    /**
     * This variable holds the key of the error message
     * @var string
     */
    protected $_name = "";
     ...
     *
     * @param string $name Holds the key of the error message
     * @param string $message Holds the error message
     */
    ...
    /**
     * Sets the key of the error message
     *
     * @param string $name Holds the key of the error message
     */
     ...
     *
     * @return string Holds the error message
     */

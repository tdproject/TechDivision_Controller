 ...
 * an exception during the execution of the
 * RequestProcessor plugin occurs.
 *
 ...
 */	
class TechDivision_Controller_Exceptions_ProcessRequestProcessorException extends Exception {			
}
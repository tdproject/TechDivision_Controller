...
/**
 * This is the exception that is thrown if an invalid 
 * resource mapping for a LookupDispatchAction was found.
 *
 ...
 */	
class TechDivision_Controller_Exceptions_InvalidResourceMappingException extends Exception {			
}
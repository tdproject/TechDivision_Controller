 ...
 * the parameter with the page to forward
 * to in the configuration file is empty.
 *
 ...
 */	
class TechDivision_Controller_Exceptions_EmptyForwardParameterException extends Exception {			
}
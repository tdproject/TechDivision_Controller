...
/**
 * This class is the holds test cases for the ActionForward
 ...
 */
class TechDivision_Controller_Action_ForwardTest
    ...
    function testConstructor() {
        $actionForward = new TechDivision_Controller_Action_Forward("name", "path");
        $this->assertTrue($actionForward->getName() == "name", "Found wrong name!");
        $this->assertTrue($actionForward->getPath() == "path", "Found wrong path!");
    }

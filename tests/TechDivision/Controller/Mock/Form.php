 ...
 */
class TechDivision_Controller_Mock_Form 
	extends TechDivision_Controller_Action_AbstractActionForm {

    /**
     * This variable holds a test value
     * @var string
     */
    public $testvalue = "";

    /**
     * This is the setter method for the test value.
     *
     * @param string $value Holds the test value
     * @return void
     */
    ...
    /**
     * This is the getter method for the test value.
     *
     * @return string Holds the test value
     */
     ...
     */
    function validate() {
        return new TechDivision_Controller_Action_Errors();
    }
}
 ...
 */
class TechDivision_Controller_Mock_EditSessionAction 
	extends TechDivision_Controller_Action_Abstract {

	/**
	 * Holds the constant for the successfull ActionForward.
	 * @var string
	 */
	const SUCCESS = "Success";

	/**
	 * Holds the constant for the failure ActionForward.
	 * @var string
	 */
     ...
     */
    function perform() {
        $this->_getActionForm()->setTestvalue("test");
        $this->_findForward(
        	TechDivision_Controller_Mock_EditSessionAction::SUCCESS
        );
    }
}